...
public class Baseball {
	public static void main(String[] args) {
		Number n = new Number();
		int number = n.get(); // 숫자 3자리 바아오는 기능
		...
		if(inputNumber1 == baseball1) {
			strike++; 
		}else if (inputNumber1 == baseball2 || inputNumber1 ==  baseball1) {
			ball++;
		}
		if(inputNumber2 == baseball2) {
			strike++; 
		}else if (inputNumber2 == baseball1 || inputNumber1 ==  baseball3) {
			ball++;}
		
		if(inputNumber3 == baseball3) {
			strike++; 
		}else if (inputNumber3 == baseball1 || inputNumber1 ==  baseball2) {
			ball++;
		}
